...
class Register:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(
            file=r"C:\Rajesh\Projects\attendance-management-system-face-recognition-main\Images_GUI\bgReg.jpg")
        ...
        get_str = Label(frame, text="Register an Admin Account", font=("times new roman", 20, "bold"), fg="#F2F2F2",
                        bg="#002B53")
        ...
        # label1
        ssq = lb1 = Label(frame, text="Security Question:", font=("times new roman", 15, "bold"), fg="#002B53",
                          bg="#F2F2F2")
        ...
        # label2
        cpwd = lb1 = Label(frame, text="Confirm Password:", font=("times new roman", 15, "bold"), fg="#002B53",
                           bg="#F2F2F2")
        ...
        # Checkbutton
        checkbtn = Checkbutton(frame, variable=self.var_check, text="Agree to Terms and Conditions",
                               font=("times new roman", 13, "bold"), fg="#002B53", bg="#F2F2F2")
        ...
        loginbtn = Button(frame, text="Login", font=("times new roman", 15, "bold"), bd=0, relief=RIDGE, fg="#fff",
                          bg="#002B53", activeforeground="white", activebackground="#007ACC")
    ...
    def reg(self):
        if (
            ...
            messagebox.showerror("Error", "Please enter and confirm the password correctly!")
        elif (self.var_check.get() == 0):
            messagebox.showerror("Error", "Please check the Terms and Conditions agreement!")
        else:
