...
class Login:
    def __init__(self, root):
        ...
        title = Label(login_frame, text="LOGIN", font=("times new roman", 30, "bold"), bg="white", fg="navyblue")
        ...
        email = Label(login_frame, text="Email", font=("times new roman", 18, "bold"), bg="white", fg="navyblue").place(
            x=250, y=150)
        ...
        pass_ = Label(login_frame, text="Password", font=("times new roman", 18, "bold"), bg="white",
                      fg="navyblue").place(x=250, y=250)
        self.txtpwd = Entry(login_frame, font=("times new roman", 15), bg="lightgray")
        self.txtpwd.place(x=250, y=280, width=350, height=35)

        btn_reg = Button(login_frame, cursor="hand2", command=self.reg, text="Register an account?",
                         font=("times new roman", 14), bg="white", bd=0, fg="navyblue").place(x=250, y=330)

        btn_forgetpwd = Button(login_frame, cursor="hand2", command=self.forget_pwd, text="Forgot password?",
                               font=("times new roman", 14), bg="white", bd=0, fg="navyblue").place(x=500, y=330)

        btn_login = Button(login_frame, text="Login", command=self.login, font=("times new roman", 20, "bold"),
                           fg="white", cursor="hand2", bg="navyblue").place(x=250, y=380, width=180, height=40)

        # Clock
        now = datetime.now()
        # dd/mm/YY
        dt_string = now.strftime("%d/%m/%Y - %H:%M:%S")
        self.lbl = Label(self.root, text=dt_string, font=("times new roman", 20,), fg="white", compound=BOTTOM,
                         bg="#081923", bd=0)
    ...
    def clock_image(self, hr, min_, sec_):
        ...
        # For Clock Image
        bg = Image.open(
            r"C:\Rajesh\Projects\attendance-management-system-face-recognition-main\Images_GUI\clock_new4.png")
    ...
    def login(self):
        if (self.txtuser.get() == "" or self.txtpwd.get() == ""):
            ...
            messagebox.showinfo("Sussessfully",
                                "Welcome to the Face Recognition Attendance Management System")
        else:
            ...
            if row == None:
                ...
                open_min = messagebox.askyesno("Admin", "Only for admin access")
                if open_min > 0:
                    self.new_window = Toplevel(self.root)
    ...
    def reset_pass(self):
        if self.var_ssq.get() == "Select":
            ...
            messagebox.showerror("Error", "Please enter an answer!", parent=self.root2)
    ...
    def forget_pwd(self):
        if self.txtuser.get() == "":
            messagebox.showerror("Error", "Please enter your email ID to reset the password!")
        else:
            conn = mysql.connector.connect(user='root', password='Pass@123', host='localhost',
                                           database='face_recognition',
                                           port=3306)
            ...
            if row == None:
                ...
                l = Label(self.root2, text="Forgot Password", font=("times new roman", 25, "bold"), fg="#fff",
                          bg="#002B53")
                l.place(x=0, y=10, relwidth=1)
                # -------------------fields-------------------
                # label1
                ssq = lb1 = Label(self.root2, text="Select a security question:", font=("times new roman", 15, "bold"),
                                  fg="#002B53", bg="#F2F2F2")
                ssq.place(x=45, y=80)
                ...
                # label2
                sa = lb1 = Label(self.root2, text="Answer:", font=("times new roman", 15, "bold"), fg="#002B53",
                                 bg="#F2F2F2")
                sa.place(x=45, y=150)
...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        # title section
        title_lb1 = Label(bg_img, text="Face Recognition Attendance Management System", font=("verdana", 20, "bold"),
        ...
        std_img_btn = Image.open(
            r"C:\Rajesh\Projects\attendance-management-system-face-recognition-main\Images_GUI\std1.jpg")
        ...
        std_b1_1 = Button(bg_img, command=self.student_pannels, text="Students", cursor="hand2",
                          font=("tahoma", 15, "bold"), bg="white", fg="navyblue")
        std_b1_1.place(x=220, y=220, width=180, height=40)

        # Detect Face  button 2
        det_img_btn = Image.open(
            r"C:\Rajesh\Projects\attendance-management-system-face-recognition-main\Images_GUI\det1.jpg")
        ...
        det_b1_1 = Button(bg_img, command=self.face_rec, text="Face Recognition", cursor="hand2", font=("tahoma", 15, "bold"),
                          bg="white", fg="navyblue")
        det_b1_1.place(x=450, y=220, width=180, height=40)

        # Attendance System  button 3
        att_img_btn = Image.open(
            r"C:\Rajesh\Projects\attendance-management-system-face-recognition-main\Images_GUI\att.jpg")
        ...
        hlp_img_btn = Image.open(
            r"C:\Rajesh\Projects\attendance-management-system-face-recognition-main\Images_GUI\hlp.jpg")
        ...
        hlp_b1_1 = Button(bg_img, command=self.helpSupport, text="Help", cursor="hand2", font=("tahoma", 15, "bold"),
                          bg="white", fg="navyblue")
        ...
        tra_img_btn = Image.open(
            r"C:\Rajesh\Projects\attendance-management-system-face-recognition-main\Images_GUI\tra1.jpg")
        ...
        tra_b1_1 = Button(bg_img, command=self.train_pannels, text="Train Data", cursor="hand2",
                          font=("tahoma", 15, "bold"), bg="white", fg="navyblue")
        tra_b1_1.place(x=220, y=420, width=180, height=40)

        # Photo   button 6
        pho_img_btn = Image.open(
            r"C:\Rajesh\Projects\attendance-management-system-face-recognition-main\Images_GUI\dataset.jpg")
        ...
        pho_b1_1 = Button(bg_img, command=self.open_img, text="Dataset", cursor="hand2", font=("tahoma", 15, "bold"),
                          bg="white", fg="navyblue")
        pho_b1_1.place(x=450, y=420, width=180, height=40)

        # Developers   button 7
        dev_img_btn = Image.open(
            r"C:\Rajesh\Projects\attendance-management-system-face-recognition-main\Images_GUI\dev.jpg")
        ...
        exi_img_btn = Image.open(
            r"C:\Rajesh\Projects\attendance-management-system-face-recognition-main\Images_GUI\exi.jpg")
        ...
        exi_b1_1 = Button(bg_img, command=self.Close, text="Logout", cursor="hand2", font=("tahoma", 15, "bold"),
                          bg="white", fg="navyblue")
