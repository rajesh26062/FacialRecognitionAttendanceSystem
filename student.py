...
class Student:
    def __init__(self, root):
        ...
        # backgorund image
        bg1 = Image.open(r"C:\Rajesh\Projects\attendance-management-system-face-recognition-main\Images_GUI\bg4.jpg")
        ...
        # title section
        title_lb1 = Label(bg_img, text="Student Information Management System", font=("verdana", 20, "bold"), bg="navyblue",
                          fg="white")
        ...
        left_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE, text="Student Information",
                                font=("verdana", 10, "bold"), fg="navyblue")
        ...
        # label Department
        dep_label = Label(current_course_frame, text="Department", font=("verdana", 10, "bold"), bg="white",
                          fg="navyblue")
        ...
        dep_combo = ttk.Combobox(current_course_frame, textvariable=self.var_dep, width=15,
                                 font=("verdana", 10, "bold"), state="readonly")
        dep_combo["values"] = (
        "Computer Science and Engineering", "Information Technology", "Data Science and AI", "Digital Art Design",
        ...
        # label Course
        cou_label = Label(current_course_frame, text="Course", font=("verdana", 10, "bold"), bg="white",
                          fg="navyblue")
        ...
        cou_combo = ttk.Combobox(current_course_frame, textvariable=self.var_course, width=15,
                                 font=("verdana", 10, "bold"), state="readonly")
        cou_combo["values"] = ("B.Tech", "M.Tech", "MCA", "BCA", "BSC", "MSC", "BBA", "MBA")
        cou_combo.current(0)
        ...
        # label Year
        year_label = Label(current_course_frame, text="Year", font=("verdana", 10, "bold"), bg="white",
                           fg="navyblue")
        ...
        # label Semester
        year_label = Label(current_course_frame, text="Semester", font=("verdana", 10, "bold"), bg="white", fg="navyblue")
        ...
        year_combo = ttk.Combobox(current_course_frame, textvariable=self.var_semester, width=15,
                                  font=("verdana", 10, "bold"), state="readonly")
        year_combo["values"] = ("1st Semester", "2nd Semester", "3rd Semester", "4th Semester", "5th Semester",
        ...
        # Student id
        studentId_label = Label(class_Student_frame, text="Student ID", font=("verdana", 10, "bold"), fg="navyblue",
                                bg="white")
        ...
        # Student name
        student_name_label = Label(class_Student_frame, text="Student Name", font=("verdana", 10, "bold"),
        ...
        # Class Didvision
        student_div_label = Label(class_Student_frame, text="Class Division", font=("verdana", 10, "bold"), fg="navyblue",
                                  bg="white")
        student_div_label.grid(row=1, column=0, padx=5, pady=5, sticky=W)

        div_combo = ttk.Combobox(class_Student_frame, textvariable=self.var_div, width=13, font=("verdana", 10, "bold"),
                                 state="readonly")
        ...
        # Roll No
        student_roll_label = Label(class_Student_frame, text="Roll No.", font=("verdana", 10, "bold"),
                                   fg="navyblue", bg="white")
        ...
        # Gender
        student_gender_label = Label(class_Student_frame, text="Gender", font=("verdana", 10, "bold"),
                                     fg="navyblue", bg="white")
        ...
        # Date of Birth
        student_dob_label = Label(class_Student_frame, text="DOB", font=("verdana", 10, "bold"), fg="navyblue",
                                  bg="white")
        ...
        # Email
        student_email_label = Label(class_Student_frame, text="Email:", font=("verdana", 10, "bold"), fg="navyblue",
                                    bg="white")
        ...
        # Phone Number
        student_mob_label = Label(class_Student_frame, text="Phone Number", font=("verdana", 10, "bold"), fg="navyblue",
                                  bg="white")
        ...
        # Address
        student_address_label = Label(class_Student_frame, text="Address", font=("verdana", 10, "bold"), fg="navyblue",
                                      bg="white")
        ...
        # Teacher Name
        student_tutor_label = Label(class_Student_frame, text="Teacher Name", font=("verdana", 10, "bold"),
                                    fg="navyblue", bg="white")
        ...
        radiobtn1 = ttk.Radiobutton(class_Student_frame, text="With Image", variable=self.var_radio1,
                                    value="With Image")
        radiobtn1.grid(row=5, column=0, padx=5, pady=5, sticky=W)

        radiobtn2 = ttk.Radiobutton(class_Student_frame, text="Without Image", variable=self.var_radio1,
                                    value="Without Image")
        ...
        # save button
        save_btn = Button(btn_frame, command=self.add_data, text="Save", width=7, font=("verdana", 10, "bold"),
                          fg="white", bg="navyblue")
        save_btn.grid(row=0, column=0, padx=5, pady=10, sticky=W)

        # update button
        update_btn = Button(btn_frame, command=self.update_data, text="Update", width=7, font=("verdana", 10, "bold"),
                            fg="white", bg="navyblue")
        update_btn.grid(row=0, column=1, padx=5, pady=8, sticky=W)

        # delete button
        del_btn = Button(btn_frame, command=self.delete_data, text="Delete", width=7, font=("verdana", 10, "bold"),
                         fg="white", bg="navyblue")
        del_btn.grid(row=0, column=2, padx=5, pady=10, sticky=W)

        # reset button
        reset_btn = Button(btn_frame, command=self.reset_data, text="Reset", width=7, font=("verdana", 10, "bold"),
                           fg="white", bg="navyblue")
        reset_btn.grid(row=0, column=3, padx=5, pady=10, sticky=W)

        # take photo button
        take_photo_btn = Button(btn_frame, command=self.generate_dataset, text="Take image", width=9,
                                font=("verdana", 10, "bold"), fg="white", bg="navyblue")
        take_photo_btn.grid(row=0, column=4, padx=5, pady=10, sticky=W)

        # update photo button
        update_photo_btn = Button(btn_frame, text="Update photo", width=9, font=("verdana", 10, "bold"), fg="white",
                                  bg="navyblue")
        ...
        search_frame = LabelFrame(right_frame, bd=2, bg="white", relief=RIDGE, text="Search By",
                                  font=("verdana", 10, "bold"), fg="navyblue")
        search_frame.place(x=10, y=5, width=635, height=80)

        # Phone Number
        search_label = Label(search_frame, text="Phone number", font=("verdana", 10, "bold"), fg="navyblue",
                             bg="white")
        ...
        self.student_table.heading("Mob-No", text="Phone number")
        self.student_table.heading("Address", text="Address")
        self.student_table.heading("Roll-No", text="RollNo")
        self.student_table.heading("Email", text="Email")
        self.student_table.heading("Teacher", text="Teacher")
        self.student_table.heading("Photo", text="Image")
    ...
    def fetch_data(self):
        conn = mysql.connector.connect(user='root', password='Pass@123', host='localhost', database='face_recognition',
                                       port=3306)
        mycursor = conn.cursor()
    ...
    def generate_dataset(self):
        if self.var_dep.get() == "Select Department" or self.var_course.get == "Select Course" or self.var_year.get() == "Select Year" or self.var_semester.get() == "Select Semester" or self.var_std_id.get() == "" or self.var_std_name.get() == "" or self.var_div.get() == "" or self.var_roll.get() == "" or self.var_gender.get() == "" or self.var_dob.get() == "" or self.var_email.get() == "" or self.var_mob.get() == "" or self.var_address.get() == "" or self.var_teacher.get() == "":
            ...
            try:
                ...
                messagebox.showinfo("Result", "Data set creation completed!", parent=self.root)
            except Exception as es:
                messagebox.showerror("Error", f"Due to: {str(es)}", parent=self.root)
